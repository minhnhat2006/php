<?php
/*
 Shortcode: hero-slider-2
*/

 function hero_slider_2($params) {
	...
	ob_start();
 	...
 	<div class="hero" style="height: 500px;">
 		...
 		<div class="lt-carousel lt-carousel-single full-width" data-items="1" data-single-item="true" data-smart-speed="500" data-bg=".bg-wrap" data-autoplay="false" data-autoplay-timeout="" data-autoplay-hover-pause="true" data-loop="true" data-nav="true" data-dots="false">
 			<?php
 			...
 			foreach ($pickedup_properties as $property) {
 				...
 				setup_postdata( $post );
				include( get_template_directory() . '/template-parts/content-item-slider-2.php');
 			}
 			?>
 		</div>
 	</div>
...
add_shortcode( 'hero-slider-2', 'hero_slider_2' );