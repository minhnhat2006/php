        ...
        <div id="tabs">
            ...
            <div id="tabs-5">
                <ul>
                    ...
                    <li><a href="https://currency-switcher.com/get-flags-free/" target="_blank" class="button button-primary"><?php _e("GET FREE FLAGS IMAGES", 'woocommerce-currency-switcher') ?></a></li>
