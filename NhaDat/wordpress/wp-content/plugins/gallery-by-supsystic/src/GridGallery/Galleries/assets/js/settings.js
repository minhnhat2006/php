...
(function (app, $) {
	...
	Controller.prototype.slimScrollOnScrollEvent = (function(e, pos) {
		...
		var x = $('.gg-anchor-nav-links[href="' + e.data.oy[8].id + '"]');
    ...
    $(document).ready(function () {
        ...
        if (qs.module === 'galleries' && qs.action === 'settings') {
            ...
            $('a').not('.nav-tab, .wp-color-result, .gg-anchor-nav-links').on('click', function(event) {
